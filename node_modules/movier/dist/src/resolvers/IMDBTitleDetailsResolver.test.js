    ...
    titlesToTest.forEach((testData) => {
        test(`check ${testData.name} ${testData.titleYear} result`, async () => {
            ...
            if (testData.directors !== undefined) {
                expect(result.directors.length).toBeGreaterThanOrEqual(testData.directors.length);
            ...
            if (testData.casts !== undefined) {
                ...
                for (const castData of testData.casts.tests) {
                    ...
                    if (castData.episodes) {
                        expect(cast.episodeCredits?.totalEpisodes).toBeGreaterThanOrEqual(castData.episodes);
